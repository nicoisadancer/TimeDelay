...
#define GPIO_Q2 GPIO_NUM_23				// Pin 23.
...
extern "C" void app_main(void)
{
    ...
    */
    ...
    while (true) // Endlos-Schleife
    {
        ...
        gpio_set_level(GPIO_Q2, I1 and I2 and I3 );

        // 8000ms warten  = Intervallzeit des Tasks
        vTaskDelay(8000 / portTICK_PERIOD_MS); // 8000ms cycle for Test.
    }
}
